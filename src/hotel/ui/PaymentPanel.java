...
public class PaymentPanel extends javax.swing.JDialog {
    ...
    private void updateTotalCheckBox() {
        ...
        try {
            for (int i = 0; i < rows; i++) {
                Object value = tablePayment.getModel().getValueAt(i, 5);
    
                if (value != null) {
                    if (value instanceof Integer) {
                        total += (Integer) value;
                    } else {
                        System.err.println("Warning: Non-integer value at row " + i);
                    }
                }
            }
            ...
            System.err.println("Error calculating total: " + ex.getMessage());
        }
    }
